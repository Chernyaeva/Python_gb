class Car:
    ...
    def go(self) -> None:
        ...
        """
        self._speed += 15
        print(f'Машина {self._name} повысила скорость на 15: {self._speed}')
    ...
    def turn(self, direction: str) -> None:
        ...
        if direction in ['направо', 'налево', 'прямо', 'назад']:
            print(f'{self._name} движется {direction}')
        else:
    ...
    def show_speed(self) -> None:
        ...
        """
        print(f'{self._name} текущая скорость {self._speed} км/час')
        if self.is_police:
...
class TownCar(Car):
    ...
    def show_speed(self) -> None:
        ...
        :return: в stdout выводит сообщение формата
            '<название марки машины>: текущая скорость <значение текущей скорости> км/час'
            При значении скорости свыше 60 (выводиться сообщение Alarm!!! Speed!!!
        """
        if self._speed > 60:
            print('Alarm!!! Speed!!!')
        else:
...
class WorkCar(Car):
    ...
    def show_speed(self) -> None:
        ...
        :return: в stdout выводит сообщение формата
            '<название марки машины>: текущая скорость <значение текущей скорости> км/час'
            При значении скорости свыше 40 (выводиться сообщение Alarm!!! Speed!!!
        """
        if self._speed > 40:
            print('Alarm!!! Speed!!!')
        else:
